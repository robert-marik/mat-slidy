...
# Vztah mezi tokem a gradientem v praxi


Níže shrneme důležité praktické příklady vztahu mezi tokem a
gradientem. Všinměte si, že přes rozdílné fyzikální pozadí jsou
všechny vztahy prakticky stejné.
...
Pro stanovení tenzoru $K$ je nutno provést finančně i časově poměrně
náročné experimenty, které navíc mohou kolidovat s vlastnickým právem
pozemků. Proto se tento koeficient zpravidla pouze odhaduje a $K$ se
uvažuje v diagonálním tvaru.
